...
def setup_sqlite_db(csv_path: str = "dataset.csv", 
    ...
    try:
        ...
        if 'Unnamed: 0' in df.columns:
            ...
            logger.info("'scheme_id' column already exists.")
        else:
            logger.error("Column 'scheme_id' or 'Unnamed: 0' not found in CSV")
            raise ValueError("Column 'scheme_id' or 'Unnamed: 0' not found in CSV")
